...
<body>
    ...
    <main>
    <div class="container">
        <h5 class="text-center text-primary mt-5">Thêm mới độc giả</h5>
        <!-- Form thêm Dữ liệu nhân viên -->
        <form action="../../index.php?action=add" method="post">
            
            
            <div class="form-group">
                <label for="txtmadg">ID</label>
                <input type="text" class="form-control" id="txtmadg" name="txtmadg" placeholder="Nhập họ tên" value="<?php echo $user['ma_nhanvien']; ?>">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="txtnamsinh" name="txtnamsinh" placeholder="Nhập năm sinh">
                <!-- <small id="txtHoTenHelp" class="form-text text-muted">Có thể dùng nó hiển thị thông báo lỗi hoặc gợi ý</small> -->
            </div>
            <div class="form-group">
                <label for="txtnghenghiep">Nghề nghiệp</label>
                <input type="text" class="form-control" id=txtnghenghiep" name="txtnghenghiep" placeholder="Nghề nghiệp">
                
            </div>

            <div class="form-group">
                <label for="txtngaycapthe">Ngày cấp thẻ</label>
                <input type="date"  class="form-control" id="txtngaycapthe" name="txtngaycapthe" placeholder="Nhập ngày cấp thẻ">
               
            </div>
            <div class="form-group">
                <label for="txtngayhethan">Ngày hết hạn</label>
                <input type="date"  class="form-control" id=txtngayhethan" name="txtngayhethan" placeholder="Nhập ngày hết hạn">
